pipeline {
  ...
  stage("nexus") {
   ...
   // }
        ...
        post{
                success{
                    slackSend baseUrl: 'https://hooks.slack.com/services/', botUser: true, channel: 'phoenix_team', color: 'good', message: "build number is '[${BUILD_NUMBER}]'", notifyCommitters: true, teamDomain: 'phoenix', tokenCredentialId: 'slack-cred'
